...
top_dir=`pwd`
utils_dir="$top_dir/vendor/bliss"
patch_dir="$utils_dir/treble/patches"
private_utils_dir="$top_dir/vendor/bliss/PRIVATE"
private_patch_dir="$private_utils_dir/patches/patches/$TARGET_PRODUCT"
